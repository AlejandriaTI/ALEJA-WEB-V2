...
import { BookOpen, Brain, Trophy, Users, Star } from "lucide-react";
                            ...
                            {[
                                ...
                                <Card key={i} className="p-6">
                                    <div className="flex items-start gap-4 mb-4">
                                        <p
                                            className={`text-4xl font-bold ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                }`}
                                        >
                                            {item.num}
                                        </p>
                                    ...
                                    <h3
                                        className={`font-bold text-sm uppercase tracking-wide ${isLight ? "text-gray-900" : "text-white"
                                            }`}
                                    >
                                        {item.title}
                                    </h3>
                                    ...
                                    <div
                                        className={`h-[3px] w-24 mt-3 ${isLight ? "bg-primary" : "bg-[#0CB2D5]"
                                            }`}
                                    />
                                </Card>
                            ))}
