...
export default function PlanNegocioClient() {
    ...
    const handleWhatsApp = () => {
        const message =
            "Hola 👋, vengo desde la página web de Alejandría Consultora, quiero empezar con mi plan de negocio.";
        ...
        <div className="min-h-screen">
            ...
            <section className="relative h-[550px] w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6">
                    <motion.h1
                        ...
                        className={`text-4xl md:text-6xl font-extrabold drop-shadow-lg ${isLight ? "text-gray-900" : "text-white"
                            }`}
                    >
                    ...
                    <motion.p
                        ...
                        className={`mt-6 text-lg md:text-2xl font-light max-w-2xl mx-auto ${isLight ? "text-gray-700" : "text-white"
                            }`}
                    >
                    ...
                    >
                        <Button
                            className="px-8 py-3 rounded-full font-semibold bg-[#0CB2D5] text-white shadow-md shadow-[#0CB2D5]/40 transition-all duration-300 hover:shadow-lg hover:shadow-[#0CB2D5]/50 hover:-translate-y-px active:translate-y-0"
            ...
            <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="grid md:grid-cols-2 gap-12 items-center mb-32">
                    ...
                    >
                        <h2
                            className={`font-semibold text-lg mb-4 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                }`}
                        >
                            ¡CIMIENTOS SÓLIDOS!
                        </h2>
                        <h3
                            className={`font-bold text-3xl md:text-4xl mb-6 ${isLight ? "text-gray-900" : "text-white"
                                }`}
                        >
                            Nuestro{" "}
                            <span
                                className={`italic font-extrabold text-transparent bg-clip-text bg-linear-to-r ${isLight
                                ...
                                <motion.div key={i} variants={itemVariants}>
                                    <Card className="p-6 text-center transition flex flex-col items-center h-48 md:h-44 justify-between">
                                        <div className="w-20 h-20 flex items-center justify-center mb-4">
                                            <Icon
                                                strokeWidth={1.5}
                                                className={`w-12 h-12 scale-110 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                    }`}
                                            />
                                        </div>

                                        <p
                                            className={`font-semibold text-sm italic ${isLight ? "text-gray-900" : "text-white"
                                                }`}
                                        >
                                            {item.label}
                                        </p>
                ...
                <div className="mb-32">
                    ...
                    >
                        <p
                            className={`font-semibold text-lg uppercase mb-2 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                }`}
                        >
                            ¿Por qué un Plan de Negocio?
                        </p>
                        <p
                            className={`font-bold text-4xl md:text-5xl ${isLight ? "text-gray-900" : "text-white"
                                }`}
                        >
                            Estrategia ganadora
                        </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            {[
                                ...
                                <motion.div
                                    ...
                                    className={`flex gap-4 pb-4 border-b ${isLight ? "border-gray-200" : "border-[#2A2A4A]"
                                        }`}
                                >
                                    <div
                                        className={`w-1 shrink-0 ${isLight ? "bg-primary" : "bg-[#0CB2D5]"
                                            }`}
                                    ></div>
                                    <div>
                                        <p
                                            className={`font-extrabold text-sm md:text-base ${isLight ? "text-gray-900" : "text-white"
                                                }`}
                                        >
                                            {item.title}
                                        </p>
                                        <p
                                            className={`text-sm md:text-base ${isLight ? "text-gray-600" : "text-slate-400"
                                                }`}
                                        >
                                            {item.desc}
                                        </p>
                        ...
                        >
                            <div className="relative w-64 h-64 md:w-80 md:h-80">
                                <div
                                    className={`absolute inset-0 rounded-full blur-3xl ${isLight ? "bg-primary/20" : "bg-[#0CB2D5]/10 animate-pulse"
                                        }`}
                                ></div>
                                <div
                                ...
                                >
                                    <div className="text-center">
                                        <TrendingUp
                                            className={`w-24 h-24 mx-auto mb-4 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                }`}
                                        />
                                        <p
                                            className={`font-bold text-lg ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                }`}
                                        >
                                            Business Plan
                                        </p>
            ...
            `}
              ...
              `}
                ...
                <div id="proceso" className="mb-32">
                    ...
                    >
                        <p
                            className={`italic font-semibold text-lg uppercase mb-2 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                }`}
                        >
                            Metodología de éxito:
                        </p>
                        <p
                            className={`font-bold text-3xl md:text-4xl ${isLight ? "text-gray-900" : "text-white"
                                }`}
                        >
                            Creamos empresas{" "}
                            ...
                            {[
                                ...
                                <Card key={i} className={`p-6 transition `}>
                                    <div className="flex items-start gap-4 mb-4">
                                        <div
                                            className={`w-16 h-16 rounded-full flex items-center justify-center shrink-0 border ${isLight
                                                    ? "bg-primary/10 border-primary/20"
                                                    : "bg-[#0CB2D5]/10 border-[#0CB2D5]/20 group-hover:bg-[#0CB2D5]/20 transition-colors"
                                                }`}
                                        >
                                            <PieChart
                                                className={`w-8 h-8 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                    }`}
                                            />
                                        </div>
                                        <p
                                            className={`text-4xl font-bold opacity-50 ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                }`}
                                        >
                                            {item.num}
                                        </p>
                                    ...
                                    <h3
                                        className={`font-bold text-xl mb-2 ${isLight ? "text-gray-900" : "text-white"
                                            }`}
                                    >
                                        {item.title}
                                    </h3>
                    ...
                    >
                        {[
                            ...
                            <motion.div key={i} variants={itemVariants}>
                                ...
                                >
                                    <p
                                        className={`leading-relaxed mb-6 transition-colors ${isLight
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            <div
                                                className={`w-12 h-12 rounded-full flex items-center justify-center border ${isLight
                                                        ? "bg-primary/10 border-primary/20"
                                            ...
                                            <div>
                                                ...
                                                <p
                                                    className={`text-sm ${isLight ? "text-primary" : "text-[#0CB2D5]"
                                                        }`}
                                                >
